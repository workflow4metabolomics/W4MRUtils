...
Due to the diversity of tools, W4M chose to adopt common standards accross its tools,
in particular regarding data table formats and basics data checks.
It also intents to gather utilitary functions to help the construction of R-based Galaxy tools using W4M standards,
...
To use these functions, it is usefull to understand the choices made by W4M,
...
as many columns as you want, each colum being a specific information about samples (*e.g.* a header indicating 'Groups'
...
identifiers are positiones as the first column in the table, and additional columns correspond to information about
